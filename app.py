...
9. **Emerging Risks**: 2-3 sentences identifying potential risks that could emerge from this phenomenon over the coming years — risks that are not yet fully formed but that this phenomenon could give rise to.
10. **Insurance Impact**: 2-3 sentences explaining the specific implications of this phenomenon for insurance brokers and their clients — covering which lines of coverage are most affected, potential claims exposure, and any client advisory actions brokers should consider.
11. **Source Confidence**: Assess the overall quality of sources backing this phenomenon. Return "High" (backed by multiple tier-1 sources such as Reuters, BBC, peer-reviewed journals, WEF, OECD), "Medium" (supported by a credible mix of sources), or "Low" (primarily weaker sources, single references, or speculation-heavy content).
...
[
  {{
    ...
    "emerging_risks": "2-3 sentences on potential risks that could emerge from this phenomenon over the coming years...",
    "insurance_impact": "2-3 sentences on implications for insurance brokers and their clients, covering affected lines of coverage, claims exposure, and advisory actions...",
